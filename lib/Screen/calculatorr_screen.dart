...
class CalculatorrScreen extends StatefulWidget {
  const CalculatorrScreen({super.key});

  @override
  State<CalculatorrScreen> createState() => _CalculatorScreenState();
}

class _CalculatorScreenState extends State<CalculatorrScreen> {
